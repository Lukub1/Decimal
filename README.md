...
## Часть 1. Реализация функции библиотеки decimal.h

Необходимо реализовать описанные [выше](#информация) функции библиотеки:
